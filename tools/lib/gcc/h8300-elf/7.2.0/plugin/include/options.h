...
#define MASK_ADDRESSES (1U << 0)
#define MASK_ALIGN_300 (1U << 1)
#define MASK_EXR (1U << 2)
#define MASK_H8300H (1U << 3)
#define MASK_INT32 (1U << 4)
#define MASK_NORMAL_MODE (1U << 5)
#define MASK_NEXR (1U << 6)
#define MASK_QUICKCALL (1U << 7)
#define MASK_RELAX (1U << 8)
#define MASK_H8300S_1 (1U << 9)
#define MASK_MAC (1U << 10)
#define MASK_SLOWBYTE (1U << 11)
#define MASK_H8300SX (1U << 12)

#define TARGET_ADDRESSES ((target_flags & MASK_ADDRESSES) != 0)
#define TARGET_ADDRESSES_P(target_flags) (((target_flags) & MASK_ADDRESSES) != 0)
#define TARGET_ALIGN_300 ((target_flags & MASK_ALIGN_300) != 0)
#define TARGET_ALIGN_300_P(target_flags) (((target_flags) & MASK_ALIGN_300) != 0)
#define TARGET_EXR ((target_flags & MASK_EXR) != 0)
#define TARGET_EXR_P(target_flags) (((target_flags) & MASK_EXR) != 0)
#define TARGET_H8300H ((target_flags & MASK_H8300H) != 0)
#define TARGET_H8300H_P(target_flags) (((target_flags) & MASK_H8300H) != 0)
#define TARGET_INT32 ((target_flags & MASK_INT32) != 0)
#define TARGET_INT32_P(target_flags) (((target_flags) & MASK_INT32) != 0)
#define TARGET_NORMAL_MODE ((target_flags & MASK_NORMAL_MODE) != 0)
#define TARGET_NORMAL_MODE_P(target_flags) (((target_flags) & MASK_NORMAL_MODE) != 0)
#define TARGET_NEXR ((target_flags & MASK_NEXR) != 0)
#define TARGET_NEXR_P(target_flags) (((target_flags) & MASK_NEXR) != 0)
#define TARGET_QUICKCALL ((target_flags & MASK_QUICKCALL) != 0)
#define TARGET_QUICKCALL_P(target_flags) (((target_flags) & MASK_QUICKCALL) != 0)
...
#define TARGET_H8300S_1_P(target_flags) (((target_flags) & MASK_H8300S_1) != 0)
#define TARGET_MAC ((target_flags & MASK_MAC) != 0)
#define TARGET_MAC_P(target_flags) (((target_flags) & MASK_MAC) != 0)
#define TARGET_SLOWBYTE ((target_flags & MASK_SLOWBYTE) != 0)
#define TARGET_SLOWBYTE_P(target_flags) (((target_flags) & MASK_SLOWBYTE) != 0)
#define TARGET_H8300SX ((target_flags & MASK_H8300SX) != 0)
#define TARGET_H8300SX_P(target_flags) (((target_flags) & MASK_H8300SX) != 0)
...
enum opt_code
{
  ...
  OPT_maddresses = 1150,                     /* -maddresses */
  OPT_malign_300 = 1151,                     /* -malign-300 */
  OPT_mexr = 1152,                           /* -mexr */
  OPT_mh = 1153,                             /* -mh */
  OPT_mint32 = 1154,                         /* -mint32 */
  OPT_mn = 1155,                             /* -mn */
  OPT_mno_exr = 1156,                        /* -mno-exr */
  OPT_mquickcall = 1157,                     /* -mquickcall */
  OPT_mrelax = 1158,                         /* -mrelax */
  OPT_ms = 1159,                             /* -ms */
  OPT_ms2600 = 1160,                         /* -ms2600 */
  OPT_mslowbyte = 1161,                      /* -mslowbyte */
  OPT_msx = 1162,                            /* -msx */
  OPT_n = 1163,                              /* -n */
  OPT_no_canonical_prefixes = 1164,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1165,              /* -no-integrated-cpp */
  OPT_no_pie = 1166,                         /* -no-pie */
  OPT_nocpp = 1167,                          /* -nocpp */
  OPT_nodefaultlibs = 1168,                  /* -nodefaultlibs */
  ...
  OPT_o = 1173,                              /* -o */
  OPT_p = 1174,                              /* -p */
  OPT_pass_exit_codes = 1175,                /* -pass-exit-codes */
  /* OPT_pedantic = 1176, */                 /* -pedantic */
  OPT_pedantic_errors = 1177,                /* -pedantic-errors */
  OPT_pg = 1178,                             /* -pg */
  OPT_pie = 1179,                            /* -pie */
  OPT_pipe = 1180,                           /* -pipe */
  OPT_print_file_name_ = 1181,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1182,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1183,          /* -print-multi-directory */
  OPT_print_multi_lib = 1184,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1185,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1186,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1187,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1188,               /* -print-prog-name= */
  OPT_print_search_dirs = 1189,              /* -print-search-dirs */
  OPT_print_sysroot = 1190,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1191,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1192,                          /* -quiet */
  OPT_r = 1193,                              /* -r */
  OPT_remap = 1194,                          /* -remap */
  OPT_s = 1195,                              /* -s */
  OPT_save_temps = 1196,                     /* -save-temps */
  OPT_save_temps_ = 1197,                    /* -save-temps= */
  OPT_shared = 1198,                         /* -shared */
  OPT_shared_libgcc = 1199,                  /* -shared-libgcc */
  /* OPT_specs = 1200, */                    /* -specs */
  OPT_specs_ = 1201,                         /* -specs= */
  OPT_static = 1202,                         /* -static */
  OPT_static_libasan = 1203,                 /* -static-libasan */
  OPT_static_libgcc = 1204,                  /* -static-libgcc */
